function threshold_tms_syn_1(idx)
...
syn_weight = load(strcat(workspace, filesep, 'data', filesep, 'synaptic_weight_1_threshold.mat'));
syn_weight = cell2mat(struct2cell(syn_weight));
syn_perc = 0.1; 
syn_weight_val = sprintf('%.7f', (syn_weight * syn_perc)); % define the weigth of an excitatory synapse (zero = no synaptic input)
sim = 'spTMS_syn';
