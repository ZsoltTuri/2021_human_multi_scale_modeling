function create_shell_script_MSM_threshold_spTMS_syn(var)
arguments
    var.out_path
    var.out_name
    var.jobname
...
fprintf(fid, strcat('matlab –nodesktop -nodisplay -batch', space, '"threshold_tms_syn_1(${SLURM_ARRAY_TASK_ID})"', '\n'));
