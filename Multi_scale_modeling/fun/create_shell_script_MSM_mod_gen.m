function create_shell_script_MSM_mod_gen(var) 
arguments
    var.out_path
    var.out_name
    var.jobname
...
fprintf(fid, strcat('cd', space, var.workspace, linux_sep, 'src', linux_sep, space, '\n')); 
fprintf(fid, strcat('ml', space, ['math' linux_sep 'matlab' linux_sep 'R2020b \n']));
fprintf(fid, strcat('matlab –nodesktop -nodisplay -nojvm -batch', space, '"model_generation"', '\n'));
